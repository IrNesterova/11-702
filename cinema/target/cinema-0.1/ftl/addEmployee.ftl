                    ...
                    <form class="form-horizontal" action="employeeList?action=addEmployee" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="id_employee" name="id_employee" type="text" placeholder="Employee id" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="sex" name="sex" type="text" placeholder="Sex" class="form-control">
                                </div>
                            </div>
